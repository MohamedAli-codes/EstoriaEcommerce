...
namespace E_commerce.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager , IConfiguration configuration, SendEmail sendEmailService)
        {
            ...
            //ezay t constrain data mn 8er model bdef attributes 3la paramter
        {
            ...
            string resetUrl = Url.Action("ResetPassword", "Account", new { token }, protocol: Request.Scheme, host: Request.Host.Value) ?? "";  //imp

            /*sending email*/
            string senderEmail = configuration["ResendEmail:SenderEmail"] ?? "";
    ...
    <div style=""max-width: 600px; margin: auto; background-color: #ffffff; padding: 30px; border-radius: 10px; border: 1px solid #ddd;"">
      ...
      <p style=""font-size: 14px; color: #666;"">
        If you didn’t request this, you can safely ignore this email.
            ...
            await sendEmailService.SendEmailAsync( senderEmail, recieverEMail, emailSubject, htmlContent);
